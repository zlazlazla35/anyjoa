                ...
                <div className='viewedContent2'>
                  <h4 className='contentTitle'>요일별 추천 애니</h4>
                        <Nav className="byDay" variant="tabs" defaultActiveKey="link-0">
                          <Nav.Item className='day'>
                            <Nav.Link eventKey="link-0">월</Nav.Link>
                          </Nav.Item>
                          <Nav.Item className='day'>
                            <Nav.Link eventKey="link-1">화</Nav.Link>
                          </Nav.Item>
                          <Nav.Item className='day'>
                            <Nav.Link eventKey="link-2">수</Nav.Link>
                          </Nav.Item>
                          <Nav.Item className='day'>
                            <Nav.Link eventKey="link-2">목</Nav.Link>
                          </Nav.Item>
                          <Nav.Item className='day'>
                            <Nav.Link eventKey="link-2">금</Nav.Link>
                          </Nav.Item>
                          <Nav.Item className='day'>
                            <Nav.Link eventKey="link-2">토</Nav.Link>
                          </Nav.Item>
                          <Nav.Item className='day'>
                            <Nav.Link eventKey="link-2">일</Nav.Link>
                          </Nav.Item>
                        </Nav>
