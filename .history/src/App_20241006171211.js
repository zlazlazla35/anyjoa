                ...
                <div className='viewedContent2'>
                  <h4 className='contentTitle'>요일별 추천 애니</h4>
                        <Nav className="byDay" variant="tabs" defaultActiveKey="link-0">
                          ...
                          <Nav.Link className='day' eventKey="link-1">월</Nav.Link>
                          <Nav.Link className='day' eventKey="link-2">월</Nav.Link>
                          <Nav.Link className='day' eventKey="link-3">월</Nav.Link>
                          <Nav.Link className='day' eventKey="link-4">월</Nav.Link>
                          <Nav.Link className='day' eventKey="link-5">월</Nav.Link>
                          <Nav.Link className='day' eventKey="link-6">월</Nav.Link>
                        </Nav>
