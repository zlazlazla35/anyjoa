...
function AniDetail({setPopUp, aniAll, clickAniInfo, carlCheck}){
                ...
                <div className='aineMorePopup'>
                    ...
                    <div className='aniMoreContent'>
                        ...
                        <button className='add' onClick={(()=>{
                            ...
                            {
                                carlCheck == faCheck ? <FontAwesomeIcon icon={faCheck} /> : <FontAwesomeIcon icon={faPlus} />
                            }
                        </button>
                        </div>
