        ...
        <div className='mo_headerWrap_inner'>
          ...
          <div className={`left_menu ${moSearch}`}>
            ...
            <div className='mo_userSrarchBox'>
              <input placeholder='제목 검색' ref={userSearchOn} />
              <FontAwesomeIcon className='GlasIcon' icon={faMagnifyingGlass} ref={userSearchOn2} />
              <button className='textRemove' ref={userSearchOn3}>
