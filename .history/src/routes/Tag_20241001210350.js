                                ...
                                return(
                                    <li key={i} onClick={((e)=>{
                                        ...
                                        ctgoryResult.forEach((data, i)=>{
                                            // data.category에서 copy 배열 값들이 포함 안된다면 return 이런 소스를 해볼게임 ㄱㄷ.. ㅎ
                                            var pick = data.category;
                                            beforeArray.push(data)
                                                                             
                                        })
                                        console.log(beforeArray)
                                        beforeArray.forEach((inner, index)=>{

                                            copy.forEach((choice, leng)=>{        
                                                

                                                console.log('비교 작품 카테고리 => ' + beforeArray[leng].category )
                                                    console.log('선택 태그 카테고리 => ' + choice )

                                                // if(beforeArray[index].category == choice[leng]){
                                                //     console.log('비교 작품 카테고리 => ' + beforeArray[leng].category )
                                                //     console.log('선택 태그 카테고리 => ' + choice[leng] )
