                                ...
                                <SwiperSlide key={i}>
                                  <div className='userViewCard'>
                                    <div className='userView' onClick={(()=>{ 
                                      ...
                                      <div className='userView hoverCard' onClick={(()=>{ 
                                      setPopUp(true);
                                      setClickAniInfo(a);
                                      ...
                                      setUseClickAni(copy);
                                        ...
                                        <div className='imgBox' style={{backgroundImage: `url(/image/${a.image})`, backgroundPosition : 'center', backgroundSize : 'cover'}}>
                                          <ReactPlayer  url={a.link} loop={true} playing={true} muted={true} controls={false} className="video" />
                                        </div>
                                      </div>
                                  </div>
                                </SwiperSlide>
