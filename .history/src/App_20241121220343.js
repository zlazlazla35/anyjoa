      ...
      <div className={`mo_headerWrap ${moNav}`}>
        <div className='mo_headerWrap_inner'>
          ...
          <div className={`left_menu ${moSearch}`}>
            <button className='mo_search' onClick={()=>{
              setMoSearch('active')
            }}>
              <FontAwesomeIcon icon={faMagnifyingGlass} />
            </button>
            <div className='mo_userSrarchBox'>
              <input placeholder='제목 검색' ref={moUserSearchOn} />
              <FontAwesomeIcon className='GlasIcon' icon={faMagnifyingGlass} ref={moUserSearchOn2}/>
