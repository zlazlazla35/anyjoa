                        ...
                        <div className='ainiInfo_box'>
                            ...
                            <div className="btnBox">
                                ...
                                <div className="cartBtnBox">
                                    ...
                                    <button className='add' onMouseEnter={(()=>{ setHoverBtn(true); afterCart(); })} onMouseLeave={(()=>{ setHoverBtn(false); beforCart(); })}  onClick={(()=>{
                                        ...
                                        let isExisting = userCart.some(
                                            ...
                                            if(isExisting){
                                                setCartCheck(faPlus);
                                                // console.log(cartMark.current.innerHtml)
