                ...
                <div className='viewedContent2'>
                  <h4 className='contentTitle'>요일별 추천 애니</h4>
                      <Nav className="byDay" variant="tabs" defaultActiveKey={`day-${byDay}`}>
                        <Nav.Link className='day' eventKey="day-0" onClick={(()=>{ setByday(1) })}>월</Nav.Link>
                        <Nav.Link className='day' eventKey="day-1" onClick={(()=>{ setByday(2) })}>화</Nav.Link>
                        <Nav.Link className='day' eventKey="day-2" onClick={(()=>{ setByday(3) })}>수</Nav.Link>
                        <Nav.Link className='day' eventKey="day-3" onClick={(()=>{ setByday(4) })}>목</Nav.Link>
                        <Nav.Link className='day' eventKey="day-4" onClick={(()=>{ setByday(5) })}>금</Nav.Link>
                        <Nav.Link className='day' eventKey="day-5" onClick={(()=>{ setByday(6) })}>토</Nav.Link>
                        <Nav.Link className='day' eventKey="day-6" onClick={(()=>{ setByday(0) })}>일</Nav.Link>
                      </Nav>
