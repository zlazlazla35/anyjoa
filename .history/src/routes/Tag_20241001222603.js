...
function Tag({aniAll, setCartCheck, cartCheck}){
    const [tag, setTag] = useState(['이세계','배틀', '학원', '스포츠', '개그', '공포', '로맨스'])
                                ...
                                return(
                                    <li key={i} onClick={((e)=>{
                                        ...
                                        ctgoryResult.forEach((data, i)=>{
                                            ...
                                            if(cg.filter( x=> copy.includes(x)) == "" ){
                                                return
                                            }else{
                                                console.log(cg.filter( x=> copy.includes(x)).length == 2)
                                            }
                                            // else if(cg.filter( x=> copy.includes(x)).length == copy.length){
                                            //     console.log(data)
                                            // }
