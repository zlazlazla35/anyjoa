...
import { faMagnifyingGlass, faXmark, faPlay, faPlus, faCheck, faCircleXmark, faBars } from "@fortawesome/free-solid-svg-icons";
...
import MoNav from './component/MoNav.js';
...
function App() {
  ...
  const moUserSearchOn = useRef();
  const moUserSearchOn2 = useRef();
  const moUserSearchOn3 = useRef();
  ...
  const closeMember = (e) => {
    ...
    if (
      moSearch == 'active' &&
      !moUserSearchOn.current.contains(e.target) &&
      !moUserSearchOn2.current.contains(e.target) &&
      !moUserSearchOn3.current.contains(e.target)
    ) {
      console.log(moUserSearchOn.current)
      setMoSearch('')
    }
  ...
  return (
    <div className="App">
      ...
      <div className={`headerWrap ${scroll}`} >
        ...
        <div className='navRight'>
          ...
          <div className={searchInput ? 'searchInputBox on' : 'searchInputBox'} >
            ...
            <FontAwesomeIcon ref={userSearchOn3} icon={faCircleXmark} className={userSearchText == '' ? 'textRemove' : 'textRemove on'} onClick={(() => {
              userSearchOn2.current.value = ''
              setUserSearchText('');
              navigate(-1);
            })} />
          </div>
      ...
      <div className='mo_headerWrap'>
        <div className='mo_headerWrap_inner'>
          <h2 className='mo_logo'>
            <NavLink to={'/'}>
              Anyjoa
            </NavLink>
          </h2>
          <div className={`left_menu ${moSearch}`}>
            <button className='mo_search' ref={moUserSearchOn} onClick={() => {
              setMoSearch('active')
            }}>
              <FontAwesomeIcon icon={faMagnifyingGlass} />
            </button>
            <div className='mo_userSrarchBox'>
              <input placeholder='제목 검색' ref={moUserSearchOn2} onInput={(e) => {
                let userSearch = e.target.value;
                setUserSearchText(userSearch);
              }} />
              <FontAwesomeIcon className='GlasIcon' icon={faMagnifyingGlass} />
              <button className={userSearchText == '' ? 'textRemove' : 'textRemove on'} ref={moUserSearchOn3} onClick={() => {
                moUserSearchOn2.current.value = ''
                setUserSearchText('');
              }}>
                <FontAwesomeIcon icon={faCircleXmark} />
              </button>
            </div>
            <button className='mo_nav' onClick={() => {
              setMoNav(true)
            }}>
      ...
      {
        moNav ? <MoNav setMoNav={setMoNav} /> : null
      }
      <Routes>
        <Route path='/' element={
          <div className='main'>
                  ...
                  mainSlide.map((data, i) => {
                    return (
                        <SwiperSlide key={i} style={{
                          ...
                          url(/image/main_slide${i + 1}${slideImg}.jpg)`,
                          backgroundPosition: 'center',
                          backgroundSize: 'cover'
                        }}>
                          <NavLink to={data.link} target='_blank'></NavLink>
            ...
            <div className='mainContent'>
              <div className='viewedContent width720_cont1'>
                {
                  useClickAni.length == 0
                    ? null
                    : <>
                      <h4 className='contentTitle width720_aniTitle'>최근본 작품</h4>
                          ...
                          useClickAni.map((a, i) => {
                            ...
                            return (
                              <div className='userView' key={i} onClick={(() => {
                                ...
                                <h2 className='aniName width720_aniName'>{a.title}, {a.series}</h2>
                              </div>
                            )
                          })
                        }
              ...
              <div className='viewedContent2 width720_cont2'>
                <h4 className='contentTitle width720_aniTitle'>요일별 추천 애니</h4>
              ...
              <div className='viewedContent2 width720_cont2'>
                <h4 className='contentTitle width720_aniTitle'>달달한 러브스토리♡</h4>
              ...
              <div className='viewedContent2 width720_cont2'>
                <h4 className='contentTitle width720_aniTitle'>화려한 액션!!</h4>
                <div className='slideBox2'>
                  <Swiper
                    navigation={true}
                    slidesPerView={6}
              ...
              <div className='viewedContent2 width720_cont2'>
                <h4 className='contentTitle width720_aniTitle'>무서운게 딱 좋아</h4>
                <div className='slideBox2'>
                  <Swiper
                    navigation={true}
                    slidesPerView={6}
              ...
              <div className='viewedContent2 width720_cont2'>
                <h4 className='contentTitle width720_aniTitle'>가슴이 뜨거워지는 스포츠</h4>
                <div className='slideBox2'>
                  <Swiper
                    navigation={true}
                    slidesPerView={6}
