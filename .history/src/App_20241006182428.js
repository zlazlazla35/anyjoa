                ...
                <div className='viewedContent2'>
                  <h4 className='contentTitle'>요일별 추천 애니</h4>
                      <Nav className="byDay" variant="tabs" defaultActiveKey={`day-${byDay}`}>
                        <Nav.Link className='day' eventKey="day-0" onClick={(()=>{ setByday(0) })}>월</Nav.Link>
                        <Nav.Link className='day' eventKey="day-1" onClick={(()=>{ setByday(1) })}>화</Nav.Link>
                        <Nav.Link className='day' eventKey="day-2" onClick={(()=>{ setByday(2) })}>수</Nav.Link>
                        <Nav.Link className='day' eventKey="day-3" onClick={(()=>{ setByday(3) })}>목</Nav.Link>
                        <Nav.Link className='day' eventKey="day-4" onClick={(()=>{ setByday(4) })}>금</Nav.Link>
                        <Nav.Link className='day' eventKey="day-5" onClick={(()=>{ setByday(5) })}>토</Nav.Link>
                        <Nav.Link className='day' eventKey="day-6" onClick={(()=>{ setByday(6) })}>일</Nav.Link>
                      </Nav>
                      <DayByAni byDay={byDay} aniAll={aniAll} setPopUp={setPopUp} setClickAniInfo={setClickAniInfo} setCartCheck={setCartCheck}  useClickAni={useClickAni} setUseClickAni={setUseClickAni}></DayByAni>
                </div>
                <div className='viewedContent2'>
...
function DayByAni({byDay, aniAll, setPopUp, setClickAniInfo, setCartCheck, setCartCheck, useClickAni, setUseClickAni}){
  return(<div>
      {
        [
          <div>
