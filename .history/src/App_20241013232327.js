...
function App() {
  ...
  return (
    <div className="App" onClick={((e)=>{
      ...
      // if(searchInputBox.current.className == e.target.className && searchInputBox.current.className == e.target.className){
      //   setSearchInput(true)
      ...
      <Reset />
        <div className={`headerWrap ${scroll}`} >
              ...
              <div className='navRight'>
                {
                  !searchInput
                  ? <button className='searchIconBox' onClick={(()=>{ setSearchInput(true) })}>
