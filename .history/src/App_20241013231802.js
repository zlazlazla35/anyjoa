...
function App() {
  ...
  return (
    <div className="App" onClick={((e)=>{
      console.log(searchInputBox.current.className)
      console.log(e.target.className)
      // if(searchInputBox.current.className == e.target.className ){
      //   console.log('인풋 클릭')
      // }else {
      //   console.log('인풋 영역 외 클릭')
      // }
      })}>
      <Reset />
        <div className={`headerWrap ${scroll}`} >
              ...
              <div className='navRight'>
                ...
                <div className= {searchInput ? 'searchInputBox on' : 'searchInputBox'} >
                  <FontAwesomeIcon className='searchIcon' icon={faMagnifyingGlass} ref={searchInputBox}/>
                  <input className='userSearch' placeholder='제목 검색'/>
                </div>
              </div>
          </div>
        <Routes>
