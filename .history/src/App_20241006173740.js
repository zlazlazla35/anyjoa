              ...
              <div className='mainContent'>
                <div className='viewedContent'>
                  {
                    ...
                    : <>
                        ...
                        <div className='viewSlide'>
                          {
                            useClickAni.map((a ,i)=>{
                                // if(useClickAni.length == 6){
                                //   useClickAni.pop();
                                //   console.log(useClickAni)
                                // }
                                console.log(useClickAni.length)
                                      return(
                ...
                <div className='viewedContent2'>
                  <h4 className='contentTitle'>요일별 추천 애니</h4>
                        <Nav className="byDay" variant="tabs" defaultActiveKey="link-0">
                          <Nav.Link className='day' eventKey="link-0">월</Nav.Link>
                          <Nav.Link className='day' eventKey="link-1">화</Nav.Link>
                          <Nav.Link className='day' eventKey="link-2">수</Nav.Link>
                          <Nav.Link className='day' eventKey="link-3">목</Nav.Link>
                          <Nav.Link className='day' eventKey="link-4">금</Nav.Link>
                          <Nav.Link className='day' eventKey="link-5">토</Nav.Link>
                          <Nav.Link className='day' eventKey="link-6">일</Nav.Link>
                        </Nav>
