...
import { faMagnifyingGlass, faXmark, faPlay, faPlus, faIgloo} from "@fortawesome/free-solid-svg-icons";
    ...
    <div className="App">
      ...
      <Routes>
        <Route path='/' element={
          <div className='main'>
            {
              popUp ? <AniDetail  setPopUp= {setPopUp} clickAniInfo={clickAniInfo} setCartCheck={setCartCheck}/> : null
            }
