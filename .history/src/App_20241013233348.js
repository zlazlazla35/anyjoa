...
function App() {
  ...
  const searchInputon = useRef();
  const searchInputon2 = useRef();
  ...
  return (
    <div className="App" onClick={((e)=>{
      console.log(searchInputBox.current)
      // console.log(e.target.className)
      // if(searchInputBox.current.className == e.target.className){
      //   setSearchInput(true)
      ...
      <Reset />
        <div className={`headerWrap ${scroll}`} >
              ...
              <div className='navRight'>
                {
                  !searchInput
                  ? <button className='searchIconBox' ref={searchInputon} onClick={(()=>{ setSearchInput(true) })}>
                ...
                <div className= {searchInput ? 'searchInputBox on' : 'searchInputBox'} >
                  <FontAwesomeIcon className='searchIcon' icon={faMagnifyingGlass}/>
                  <input className='userSearch' placeholder='제목 검색'  ref={searchInputon2}/>
                </div>
              </div>
          </div>
        <Routes>
