              ...
              <div className='mainContent'>
                ...
                <div className='viewedContent2'>
                  <h4 className='contentTitle'>요일별 추천 애니</h4>
                        <Nav className="byDay" variant="tabs" defaultActiveKey={`day-${dayLabel}`}>
                          <Nav.Link className='day' eventKey="day-0">월</Nav.Link>
                          <Nav.Link className='day' eventKey="day-1">화</Nav.Link>
                          <Nav.Link className='day' eventKey="day-2">수</Nav.Link>
                          <Nav.Link className='day' eventKey="day-3">목</Nav.Link>
                          <Nav.Link className='day' eventKey="day-4">금</Nav.Link>
                          <Nav.Link className='day' eventKey="day-5">토</Nav.Link>
                          <Nav.Link className='day' eventKey="day-6">일</Nav.Link>
                        </Nav>
                  <div>월</div>
                  <div>화</div>
                  <div>수</div>
